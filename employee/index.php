        ...
        <div class="col-sm-6 col-xl-4">
            <div class="bg-warning rounded d-flex align-items-center justify-content-between p-4">
                <div class="ms-2 text-light">
                    <p class="mb-1 text-center heading"><i class="fas fa-user-check fa-0.5x" style="color: #ffffff;"></i> Attendances</p>
                    <p class=" heading">today present : </p>
        ...
        <div class="col-sm-6 col-xl-4">
            <div class="bg-primary rounded d-flex align-items-center justify-content-between p-4">
                <div class="ms-2 text-light">
                    ...
                    <p class=" heading">Total Pending  : <?php echo $total_pending; ?> </p>
                    <p class=" heading">Total Applied  : <?php echo $total_applied; ?> </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-4">
            <div class="bg-dark rounded d-flex align-items-center justify-content-between p-3">
                <div class="ms-2 text-light">
                    ...
                    <a href="view-employee.php"> <b>View All Employees</b></a>
                </div>
            </div>
        </div>
