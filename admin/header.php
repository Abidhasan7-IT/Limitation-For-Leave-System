            ...
            <nav class="navbar navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="navbar-nav w-100 ">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle <?= $page== 'add-leavetype.php' || $page== 'manage-leave.php' || $page== 'employee-leavestatus.php' ? 'active' : ''?> " data-bs-toggle="dropdown">
                            <i class="fa fa-th me-2"></i> Leave
                            </a>
                            <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0 <?= $page== 'add-leavetype.php' || $page== 'manage-leave.php' || $page== 'employee-leavestatus.php' ? 'show' : ''?> ">
                                 ...
                                 <a href="employee-leavestatus.php" class="dropdown-item nav-item nav-link <?= $page== 'employee-leavestatus.php' ? 'active' : ''?> "> <i class="fa fa-check"></i> Accepted</a>
                            </div>
                        </div>
